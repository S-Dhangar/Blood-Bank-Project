...
<body class="body">
    ...
    <form name="myform" action="Donor_homepage.php" method="POST" autocomplete="off"  onsubmit="return validateform()">
            <input style="width:400px" type="text" name="Name" placeholder="Type name"> 
