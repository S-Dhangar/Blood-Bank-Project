...
<body>
   ...
   if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    echo "<nav class='navbar background'>
        <div class='logo'>
           <a href='First page.html'> <img src='Logo.jpg'></a> 
        </div>
        <ul>
            <li><a href='homepage.php'>Home</a></li>
            <li><a href='Bloodbankinterface.php'>Blood Banks</a></li>
            <li><a href='mybloodbank.php'>My blood bank</a></li>
...
<div class='last'>
    ...
    echo "<h1 style='color:red;'>Username Password not found</h> <a href='Blood_bank_reg.html'> Register</a>";
    echo "<br>again try to <a href='Blood_bank_login.php'><b>Login</b></a>";
